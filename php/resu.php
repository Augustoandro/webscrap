            ...
            <div class="container-fluid" id="bg">
            	...
            	<?php
                  ...
                  if(isset($_GET['search_btn']))
                  {
                    ...
                    echo "<nav>
                    <ul>
                    <li><font size='+1' color='#9999ff'><a class='current' href='resu.php?search=$search&search_btn=Scrap+Search'>All</a></font></li><li><font size='+1' color='#9999ff'><a href='imagesear.php?search=$search&search_btn=GO'>Images</a></font></li><li><font size='+1' color='#9999ff'><a href='videosear.php?search=$search&search_btn=GO'>Videos</a></font></li><li><font size='+1' color='#9999ff'><a href='newssear.php?search=$search&search_btn=GO'>News</a></font></li>
                    </ul>
                    </nav>";
                  }
                ?>
            ...
            <div class="result">
                <table>
                       <tr>
                           <?php
                                ...
                                {
                                 $search=mysqli_real_escape_string($_con,$_GET['search']);
                                 $_sql="select * from websid where stitle like '%".$search."%' limit 0,7";
                                 $rs=mysqli_query($_con,$_sql);
                                 ...
                                 while($resul3=mysqli_fetch_assoc($rs))
                                 {
                                  echo "<a href='".$resul3['slink']."'><img src='".$resul3['simg']."' height='100px'></a>";
                                 }
                                 echo "</div>";
                                }
                           ?> 
                ...
                <?php
                    ...
                    echo "<a href='imagesear.php?search=$search&search_btn=GO'><font size='+1' color='#1a1aff'>More Images for $search</font></a>";
                     echo "<hr>";
                     $results_per_page=12;
                     $_sql2="select * from websid where stitle like '%".$search."%' limit 0,156";
                     ...
                     if($_GET['page']>1){
                     	$page=$page-1;
                     	echo "<a href='resu.php?search=$search&search_btn=GO&page=".$page."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previous</a>";
                     }
                     for($page=1;$page<=$number_of_pages;$page++){
                     	echo "<a href='resu.php?search=$search&search_btn=GO&page=".$page."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$page."</a>";
                     }
                     if(!isset($_GET['page']))
                     {
                     	$page=1;
                     	$page=$page+1;
                     	echo "<a href='resu.php?search=$search&search_btn=GO&page=".$page."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Next</a>";
                     }
