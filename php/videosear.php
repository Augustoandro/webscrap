...
<script type="text/javascript">function ld()
{
    document.search_box.search.focus();
            ...
            <div class="result">
                ...
                $search=mysqli_real_escape_string($_con,$_GET['search']);
                $results_per_page=12;
            	$_sql1="select * from websid where stitle like '%".$search."%' and styp like 'video' limit 0,180";
                ...
                if($_GET['page']>1){
                     	$page=$page-1;
                     	echo "<a href='videosear.php?search=$search&search_btn=GO&page=".$page."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Previous</a>";
                     }
                     for($page=1;$page<=$number_of_pages;$page++){
                     	echo "<a href='videosear.php?search=$search&search_btn=GO&page=".$page."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$page."</a>";
                     }
                     if(!isset($_GET['page']))
                     {
                     	$page=1;
                     	$page=$page+1;
                     	echo "<a href='videosear.php?search=$search&search_btn=GO&page=".$page."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Next</a>";
                     }
